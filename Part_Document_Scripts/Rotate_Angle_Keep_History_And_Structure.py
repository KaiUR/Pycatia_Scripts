'''
    -----------------------------------------------------------------------------------------------------------------------
    Script name:    Rotate_Angle_Keep_History_And_Structure.py
    Version:        1.0
    Code:           Python3.10.4, Pycatia 0.8.3
    Release:        V5R32
    Purpose:        Rotates all hybrid shapes in a geometric set by an angle while keeping names, structure and parametric history.
...
if __name__ == "__main__":
    ...
    if inwork_hb is None:                                                                                      #If still not found, create new GS
        ...
        inwork_hb.name = "Rotate_Angle_Keep_History_And_Structure"                                              #Rename geometric set
