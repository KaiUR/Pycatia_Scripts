'''
    -----------------------------------------------------------------------------------------------------------------------
    Script name:    Mirror_Keep_History_And_Structure.py
    Version:        1.0
    Code:           Python3.10.4, Pycatia 0.8.3
    Release:        V5R32
    Purpose:        Mirrors all hybrid shapes in a geometric set while keeping names, structure and parametric history.
    ...
    Description:    This script will ask the user to select a geometric set and a mirror plane.
                    ...
                    preserve the original names of all shapes and geometric sets. Results are left as live
                    parametric features rather than converted to datums.
    dependencies = [
                    "pycatia",
                    ]
...
if __name__ == "__main__":
    ...
    if inwork_hb is None:                                                                                      #If still not found, create new GS
        ...
        inwork_hb.name = "Mirror_Keep_History_And_Structure"                                                    #Rename geometric set
