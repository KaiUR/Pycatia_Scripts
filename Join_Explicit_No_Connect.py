...
if __name__ == "__main__":
    ...
    status = selectionSet.select_element3(object_filter,"Select curves or surfaces to join" , False , 2 , False)         #Runs an interactive selection command, exhaustive version. 
    ...
    if hybrid_shape_factory.get_geometrical_feature_type(join_hybrid_shapes) == 5:                              #If surface
    ...
    elif hybrid_shape_factory.get_geometrical_feature_type(join_hybrid_shapes) == 2:                             #If curve
