'''
    -----------------------------------------------------------------------------------------------------------------------
    Script name:    Export_Points_Select_Axis_and_Geo_Set_To_CSV.py
    Version:        1.0
    Code:           Python3.10.4, Pycatia 0.8.3
    Release:        V5R32
    Purpose:        Export points from any geometric set to an csv file.
    ...
    Description:    This script will ask the user for an axis system and for a geometric set containing points.
                    ...
                    csv file. The name of the points in the exported file are the same as in catia for each point. The axis system used
